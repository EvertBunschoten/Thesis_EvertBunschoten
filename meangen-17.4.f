...
C
      ...
      WRITE(11,*) 'STAGE No, ROW No, No. BLADES',NSTG, NR1, NBLADE(NR1)
      WRITE(11,*) 'STAGE No, ROW No, No. BLADES',NSTG, NR2, NBLADE(NR2)
      WRITE(11,*)
...
C
      WRITE(11,*)'*****************************************************'
      WRITE(11,*) ' CONDITIONS FOR THE FIRST BLADE ROW OF THE STAGE. '
      IF(TURBO_TYP.EQ.'T') WRITE(11,*) ' THIS IS A TURBINE STATOR '
      IF(TURBO_TYP.EQ.'C') WRITE(11,*) ' THIS IS A COMPRESSOR ROTOR'
      WRITE(11,*)'*****************************************************'
      WRITE(11,*) 'FIRST BLADE INLET AND EXIT ANGLES ',
     &            BIN_ROW1(NSTG)*RADDEG, BOUT_ROW1(NSTG)*RADDEG
      WRITE(11,*) ' FIRST BLADE AXIAL VELOCITY     ', VXIN(NSTG)
      WRITE(11,*) ' FIRST BLADE INLET MACH NUMBER  ', MACH_REL(NLE1)
      WRITE(11,*) ' FIRST BLADE EXIT MACH NUMBER   ', MACH_REL(NTE1)
      WRITE(11,*) ' FIRST BLADE EXIT DENSITY       ', RHOMID(NSTG)
      WRITE(11,*) ' FIRST BLADE EXIT PRESSURE      ', PMID(NSTG)
      WRITE(11,*) ' FIRST BLADE INLET STAGN PRESS  ', POABS(NLE1)
      WRITE(11,*) ' FIRST BLADE EXIT STAGN PRESS   ', POABS(NTE1)
      WRITE(11,*) ' FIRST BLADE REL INLET STAG PRES', POREL(NLE1)
      WRITE(11,*) ' FIRST BLADE EXIT TEMPERATURE   ', TMID(NSTG)
      WRITE(11,*) ' FIRST BLADE EXIT STAGN TEMP    ', TO_MID
      WRITE(11,*) ' FIRST BLADE TIP RADIUS =       ', RTIPIN(NSTG)
      WRITE(11,*) ' FIRST BLADE INLET SPAN =       ', SPANIN
      WRITE(11,*) ' FIRST BLADE AXIAL CHORD=       ', AXCHRD1(NSTG)
      WRITE(11,*) ' FIRST BLADE ASPECT RATIO =     ', ASPN(NSTG)
      WRITE(11,*)
C
C
      WRITE(11,*)'*****************************************************'
      WRITE(11,*)  ' CONDITIONS FOR THE SECOND BLADE ROW OF THE STAGE.'
      IF(TURBO_TYP.EQ.'T') WRITE(11,*) ' THIS IS A TURBINE ROTOR '
      IF(TURBO_TYP.EQ.'C') WRITE(11,*) ' THIS IS A COMPRESSOR STATOR'
      WRITE(11,*)'*****************************************************'
      WRITE(11,*) ' SECOND BLADE INLET AND EXIT ANGLES ',
     &             BIN_ROW2(NSTG)*RADDEG, BOUT_ROW2(NSTG)*RADDEG
      WRITE(11,*) ' SECOND BLADE AXIAL VELOCITY    ', VXOUT(NSTG)
      WRITE(11,*) ' SECOND BLADE INLET MACH NUMBER ', MACH_REL(NLE2)
      WRITE(11,*) ' SECOND BLADE EXIT MACH NUMBER  ', MACH_REL(NTE2)
      WRITE(11,*) ' SECOND BLADE DENSITY           ', RHOEXIT(NSTG)
      WRITE(11,*) ' SECOND BLADE EXIT PRESSURE     ', PEXIT(NSTG)
      WRITE(11,*) ' SECOND BLADE INLET STAGN PRES. ', POABS(NLE2)
      WRITE(11,*) ' SECOND BLADE REL INLET STAG PR.', POREL(NLE2)
      WRITE(11,*) ' SECOND BLADE ROW EXIT STAG PRES', POABS(NTE2)
      WRITE(11,*) ' SECOND BLADE TEMPERATURE       ', TEXIT(NSTG)
      WRITE(11,*) ' SECOND BLADE STAGN EXIT TEMP.  ', TO_EXIT
      WRITE(11,*) ' SECOND BLADE TIP RADIUS =      ', RTIPEXIT(NSTG)
      WRITE(11,*) ' SECOND BLADE EXIT SPAN =       ', SPANEXIT
      WRITE(11,*) ' SECOND BLADE AXIAL CHORD =     ', AXCHRD2(NSTG)
      WRITE(11,*) ' SECOND BLADE ASPECT RATIO=     ', ASPR(NSTG)
      WRITE(11,*)'*****************************************************'
      WRITE(11,*)'*****************************************************'
C
C
      WRITE(11,*)
      WRITE(11,*)  ' THE RADII THROUGH THE STAGE ARE -  '
      WRITE(11,211) RHUB(NLE1),RTIP(NLE1),RHUB(NLE2),RTIP(NLE2)
  211 FORMAT('ROW 1 HUB RADIUS ',F8.4,'  ROW 1 TIP RADIUS ',F8.4,
     & '  ROW 2 HUB RADIUS ',F8.4,'  ROW 2 TIP RADIUS ',F8.4)
      WRITE(11,*)
      WRITE(11,*)
C
